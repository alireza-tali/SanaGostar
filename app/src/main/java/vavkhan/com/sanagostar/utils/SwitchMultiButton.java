...
public class SwitchMultiButton extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeWidth = typedArray.getDimension(R.styleable.SwitchMultiButton_strokeSwitchWidth, STROKE_WIDTH);
        mTextSize = typedArray.getDimension(R.styleable.SwitchMultiButton_textSize, TEXT_SIZE);
        mSelectedColor = typedArray.getColor(R.styleable.SwitchMultiButton_selectedSwitchColor, SELECTED_COLOR);
        mStrokeColor = typedArray.getColor(R.styleable.SwitchMultiButton_switchStrokeColor, STROKE_COLOR);
        mSelectedTextColor = typedArray.getColor(R.styleable.SwitchMultiButton_selectedTextColor, SELECTED_TEXT_COLOR);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putFloat("strokeSwitchWidth", mStrokeWidth);
        bundle.putFloat("TextSize", mTextSize);
        bundle.putInt("selectedSwitchColor", mSelectedColor);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            mStrokeWidth = bundle.getFloat("strokeSwitchWidth");
            mTextSize = bundle.getFloat("TextSize");
            mSelectedColor = bundle.getInt("selectedSwitchColor");
